...
TEMPLATES = {
    "crisis": CRISIS_TEXT,
    "title_ix": "I'm a campus assistant. For confidential support and reporting options, contact the Title IX Office at 410-455-1717. If this is an emergency, call 911/988.",
    "conduct": "I'm a campus assistant. You can report behavior or get support via Student Conduct/CARE (add link). If you feel unsafe, call 911 or Campus Police (410-455-5555).",
    "retention": "If you're considering withdrawing or transferring, review options with Advising/Student Success (add link/contact).",
    "counseling": "You can schedule counseling or get information via RIH Counseling (add link/phone).",
}
